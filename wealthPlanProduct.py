...
class WealthPlanProduct:
    @staticmethod
    def compute_product_returns(initial_investment, annual_contribution, contribution_years, maturity_year, maturity_value, start_date=datetime.today()):
